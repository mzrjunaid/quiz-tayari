...
export default function EditPaper() {
    const { paper, departments = [], subjects = [], commonTestingServices = [] } = usePage().props as unknown as CreatePaperProps;
    ...
    const form = useForm<FormValues>({
        ...
        defaultValues: {
            ...
            testing_services: paper.testing_service || {
                short: '',
                long: '',
            },
            department: paper.department || '',
            subject: paper.subject || '',
            scheduled_at: paper.scheduled_at.date_only || '',
        },
    });
    ...
    async function onSubmit(values: FormValues) {
        ...
        try {
            ...
            await router.patch(route('papers.update', paper.slug), formattedValues, {
                onSuccess: () => {
                    localStorage.removeItem('papers_draft');
                },
                onError: (errors) => {
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input type="date" min={getMinDatetime()} {...field} />
                                    </FormControl>
