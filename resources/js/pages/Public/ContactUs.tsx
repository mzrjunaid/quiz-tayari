...
const contactSchema = {
    ...
    description: 'Get in touch with the PAK QUIZ team for support, feedback, and inquiries about MCQs preparation, premium plans, or job updates.',
    mainEntity: {
        '@type': 'Organization',
        name: 'PAK QUIZ',
    ...
    return (
        <>
            <Head title="Contact Us">
                <meta
                    name="description"
                    content="Contact PAK QUIZ for support, feedback, or questions about MCQs preparation, premium membership, and latest job updates in Pakistan."
                />
                <meta name="keywords" content="Contact PAK QUIZ, MCQs help, PPSC preparation, FPSC jobs, NTS test, support, feedback" />
                <meta name="robots" content="index, follow" />
                <link rel="canonical" href="https://www.pakquiz.com/contact" />
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-600">{contactSchema.mainEntity.contactPoint.telephone}</p>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-slate-600">{contactSchema.mainEntity.contactPoint.email}</p>
